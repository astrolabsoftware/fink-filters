...
def kn_candidates_(
        ...
        classtar, jd, jdstarthist, ndethist, cdsxmatch, ssdistnr) -> pd.Series:
    ...
    ssdistnr: Pandas series
        Column containing distance to closest SSO
    ...
    ...     pdf['cdsxmatch'],
    ...     pdf['candidate'].apply(lambda x: x['ssdistnr']))
    ...
    f_kn = high_knscore & high_drb & high_classtar & new_detection & far_from_mpc
...
def kn_candidates(
        ...
        classtar, jdstarthist, ndethist, cdsxmatch, ssdistnr, ra, dec, cjdc, cfidc,
    ...
    f_kn = kn_candidates_(
        rf_kn_vs_nonkn, rf_snia_vs_nonia, snn_snia_vs_nonia, snn_sn_vs_all, drb,
        classtar, jd, jdstarthist, ndethist, cdsxmatch, ssdistnr
    )
