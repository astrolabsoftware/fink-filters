...
"""Return alerts linked to a Solar System Object from the Minor Planet Center database"""
...
def sso_ztf_candidates(roid) -> pd.Series:
    ...
    >>> f = 'fink_filters.ztf.livestream.filter_sso_ztf_candidates.filter.sso_ztf_candidates'
